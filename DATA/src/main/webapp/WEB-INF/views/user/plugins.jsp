...
<![endif]-->
	...
	<script src="${contextPath}/static/assets/js/jquery.easypiechart.js"></script>
	<script src="${contextPath}/static/assets/js/jquery.sparkline.js"></script>
	<script src="${contextPath}/static/assets/js/flot/jquery.flot.js"></script>
	<script src="${contextPath}/static/assets/js/flot/jquery.flot.pie.js"></script>
	<script
		src="${contextPath}/static/assets/js/flot/jquery.flot.resize.js"></script>
	...
	<link rel="stylesheet"
		href="${contextPath}/static/assets/css/ace.onpage-help.css" />

	<script type="text/javascript">
		ace.vars['base'] = '..';
	</script>
	<script
		src="${contextPath}/static/assets/js/ace/elements.onpage-help.js"></script>
	<script src="${contextPath}/static/assets/js/ace/ace.onpage-help.js"></script>